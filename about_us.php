...
<head>
    ...
    <link rel="apple-touch-icon" sizes="274x184" href="logo.jpg">
    <link rel="icon" type="image/png" sizes="274x184" href="logo.jpg">
    <link rel="icon" type="image/png" sizes="274x184" href="logo.jpg">
    ...
    <title>About us - Bank of Sparks</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
</head>

<body style="background-color:#876D97;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                ...
                <h1 style=" color:#FF8381;">About Us</h1>
            </div>
            <br><br>
            <img src="RISHABH.png" alt="">
            <br><br>
            <p style="color:#F9AC66;">This website is created by</p>
            <h1 style="color:#F9AC66; text-shadow:2px 2px 2px gray;">RISHABH SINGH</h1>
            <p style="color:#F9AC66;"><b>Intern at Sparks Foundation <br> THAKUR COLLEGE OF ENGINEERING AND TECHNOLOGY</b></p>
    </center>
