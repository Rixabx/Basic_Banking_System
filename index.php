...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        ...
        <div class="container-fluid">
            <a href="index.php"><img src="logo.jpg" alt=""
    ...
    <div class="container-large"
        style=" height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#525B56;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;color:1B3239;"><b>Welcome to <br>Bank of
                        Sparks!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="https://thumbor.forbes.com/thumbor/fit-in/900x510/https://www.forbes.com/advisor/wp-content/uploads/2021/04/getty_bank-accts_040521.jpeg.jpg" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="https://www.kotak.com/content/dam/Kotak/guidance/hero-slider-banner/cash-deposit-limit-in-saving-account-d.jpg" alt="" style="width:100%; height: 70%;position:absolute; z-index:-1">
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:#040C0E;"><b>Our Awesome Facilities</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color: #DCA36E; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
